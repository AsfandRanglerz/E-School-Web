<div class="modal fade" id="giveMoneyToStaffModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 terminate-student-modal-content">
            ...
            <div class="modal-body p-4">
                ...
                <div class="mt-4 position-relative">
                    <input type="text" class="form-control terminate-student-input" placeholder="Amount">
                </div>
                <div class="mt-3 position-relative">
                    <input type="text" class="form-control terminate-student-input" placeholder="Reason">
                </div>
